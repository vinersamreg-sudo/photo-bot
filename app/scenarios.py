...
SCENARIOS = (
    ...
    Scenario("neuro-session", "Нейрофотосессия", "📸", "фотосессия", "Новый реалистичный образ", "Создай реалистичный портрет, сохрани личность человека: {instruction}", None, 1, True, 90, ("портрет", "фотосессия")),
    Scenario("documents", "Фото на документы", "🪪", "другое", "Нейтральный официальный портрет", "Создай нейтральное официальное фото с ровным светом: {instruction}", None, 1, True, 100, ("документы", "официальное")),
    Scenario("memorial", "Фото на памятник", "🕊", "восстановление", "Бережный восстановленный портрет", "Создай уважительный восстановленный портрет, сохрани личность: {instruction}", None, 1, True, 110, ("памятник", "восстановление")),
)
